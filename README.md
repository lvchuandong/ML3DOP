...
All the sequences are acquired in Shandong University, Qingdao, including indoor and outdoor scenes. Dataset link is: [3DOPFormerDataset](https://pan.baidu.com/s/1gbmSz3IvnNdX-tPp6iJ0Kg?pwd=dpai)
...
An overview of 3DOPFormerDataset is given in the tables below:
